...
FPS = 60
# moving speed of spaceships, max bullets, push opponent pixels, padding on the surface
VEL = 5
BULLET_VEL = 10
...
YELLOW_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('sprint1_game/Assets', 'spaceship_yellow.png'))
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(
    YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)
RED_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('sprint1_game/Assets', 'spaceship_red.png'))
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(
    RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 270)
SPACE = pygame.transform.scale(pygame.image.load(
    os.path.join('sprint1_game/Assets', 'space.jpg')), (WIDTH, HEIGHT))
